      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('admin/products-copy', $attributes);
            ...
            <tbody>
              ...
              foreach($product as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/products-copy/update/'.$row['id'].'" class="btn btn-info">view & edit</a>  
                  <a href="'.site_url("admin").'/products-copy/delete/'.$row['id'].'" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
