...
$route['admin/products-copy']				= 'admin_products_copy/index';
$route['admin/products-copy/add']			= 'admin_products_copy/add';
$route['admin/products-copy/update']		= 'admin_products_copy/update';
$route['admin/products-copy/update/(:any)'] = 'admin_products_copy/update/$1';
$route['admin/products-copy/delete/(:any)'] = 'admin_products_copy/delete/$1';
$route['admin/products-copy/(:any)']		= 'admin_products_copy/index/$1'; //$1 = page number
